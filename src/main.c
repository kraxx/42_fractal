...
/*   Updated: 2017/09/14 14:02:25 by jchow            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	write_instructions(void)
{
	ft_putstr("\nKEYS:"
			"\n\n[36m[↑][↓][←][→][LEFT CLICK]\033[0m   Translate fractal\n"
			"[36m[I]\033[0m                        Invert controls\n[36m"
			"[RIGHT CLICK]\033[0m              Adjust Z constant\n[36m[WHEEL "
			"UP/DOWN][HOME][END]\033[0m Zoom about mouse cursor\n[36m[+][-]"
			"\033[0m                     Zoom about center\n[36m[*][/]\033[0m"
			"                     Increase/decrease fractal iterations\n[36m"
			"[[][]]\033[0m                     Increase/decrease windowsize\n"
			"[36m[NUMPAD 0]\033[0m                 Reset image\n[36m[1-8]"
			"\033[0m                      Change fractal\n[36m[FN][DEL]\033[0m"
			"                  Increase/decrease pulse speed\n[36m[P]\033[0m"
			"                        Switch on/cycle through colour pulsers\n"
			"[36m[O]\033[0m                        Switch off pulser\n[36m"
			"[A][S] + [NUMPAD 1-9]\033[0m      Set gradient colour 1/2\n[36m"
			"[Z]\033[0m                        Switch on custom fractal "
			"gradient\n[36m[X]\033[0m                        Cycle fractal "
			"contrasted colours\n[36m[C]\033[0m                        Cycle "
			"fractal smooth colours\n[36m[V]\033[0m                        "
...
static int	write_usage(void)
{
	ft_putstr("usage: ./fractol [ [31mjulia\033[0m | [32mmandelbrot\033[0m "
			...
			"| [36mfish\033[0m | [37mtime\033[0m | [31mray\033[0m]\n");
	return (0);
}
